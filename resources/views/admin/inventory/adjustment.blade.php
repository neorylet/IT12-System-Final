...
<div class="activity-section" style="margin-top:16px;">
  <div class="activity-header">Adjustment Form</div>

  <form method="POST" action="{{ route('admin.inventory.adjust.store') }}" style="padding:12px;">
    @csrf
    ...
    <div class="form-grid" style="display:grid; grid-template-columns: 1.2fr 1fr 1fr; gap:12px;">
      ...
      <div style="grid-column: 1 / -1;">
        ...
        <input name="remarks" class="input-field" style="width:100%;"
               value="{{ old('remarks') }}" placeholder="Reason for adjustment...">
      </div>
    </div>
    ...
    <div style="margin-top:14px; border-top:1px solid #efe5da; padding-top:14px;">
      <div style="display:flex; justify-content:space-between; align-items:center; gap:10px; flex-wrap:wrap;">
        <div>
          ...
          <div style="font-size:12px; color:#9a8575;">Set / Increase / Decrease per row.</div>
        </div>
        ...
        <table class="activity-table">
          ...
          <tbody id="itemsTbody">
            <tr>
              ...
              <td>
                <select name="items[0][mode]" class="input-field" style="width:100%;" required>
              ...
              <td>
                <input type="number" min="0" name="items[0][quantity]" class="input-field"
                       style="width:100%; text-align:right;" value="{{ old('items.0.quantity',0) }}" required>
              </td>
  ...
  function rowHtml(index){
    return `
      <tr>
        ...
        <td>
          <select name="items[${index}][mode]" class="input-field" style="width:100%;" required>
            <option value="set">Set</option>
            <option value="increase">Increase</option>
            <option value="decrease">Decrease</option>
          </select>
        </td>
        <td><input type="number" min="0" name="items[${index}][quantity]" class="input-field" style="width:100%; text-align:right;" value="0" required></td>
