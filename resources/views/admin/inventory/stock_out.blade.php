  ...
  <div class="form-shell form-shell-wide">
    <div class="form-card">
      <div class="form-card-header">
        <h2 class="form-card-title">Stock Out Form</h2>
        <p class="form-card-subtitle">Remove one or more product quantities under a single stock-out transaction.</p>
      </div>

      <form method="POST" action="{{ route('admin.inventory.stockout.store') }}" class="transaction-form">
        @csrf
        ...
        <div class="transaction-items-section">
          <div class="transaction-items-header">
            <div>
              ...
              <div class="transaction-items-subtitle">Multiple rows will be saved under one stock-out transaction.</div>
            </div>
  ...
  function rowHtml(index){
    return `
      <tr>
        ...
        <td style="text-align:right;"><button type="button" class="btn-row-remove btnRemoveRow">✕</button></td>
      </tr>
    `;
  }
